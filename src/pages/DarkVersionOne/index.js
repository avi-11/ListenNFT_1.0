  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background: `url(${bg01}) background-position: center center`,
        }}
            ...
            <div className="col-lg-7 col-md-6">
              <div className="title-heading">
                ...
                <p className="text-white-50 para-desc mb-0 mb-0">
                  ...
                  artists of all time with their fans and unique token
                  collectors!
                </p>
              ...
              <div className="bg-half-100 bg-gradient-primary">
                <div className="container">
                    ...
                    <div className="col">
                      <div className="section-title text-center mb-4 pb-2">
                        <h4 className="title text-white title-dark mb-4">
                          Join the fastest growing ListenNFTs <br /> with more
                          than 2000+ NFTs
                        </h4>
                        <p className="text-white-50 para-desc mb-0 mx-auto">
                          We are a huge marketplace dedicated to connecting
                          great artists of all time with their fans and unique
                          token collectors!
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 mt-4 pt-2">
                      <div className="card p-4 rounded-md shadow bg-white">
                        <h4 className="mb-4">Learn more about ListenNFT</h4>
                        <p className="text-muted mb-0">
                          We are a huge marketplace dedicated to connecting
                          great artists of all genre.
                        </p>
            ...
            <div className="row justify-content-center">
              <div className="col">
                <div className="section-title text-center mb-5 pb-3">
                  ...
                  <p className="text-muted para-desc mb-0 mx-auto">
                    We are a huge marketplace dedicated to connecting great
                    artists of all genre with their fans and unique token
                    collectors!
                  </p>
                </div>
              </div>
