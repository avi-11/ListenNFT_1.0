...
const DarkVersionThree = ({ marketplace, nft }) => {
  ...
  const buyMarketItem = async (item) => {
    await (
      await marketplace1.purchaseItem(item.itemId, { value: item.totalPrice })
    ).wait();
  ...
  return (
    <>
      {/* Start Home */}
      <section
        className="bg-half-260 d-flex align-items-center"
        style={{
            ...
            <div className="col-12">
              <div className="title-heading text-center">
                ...
                <p className="text-white title-dark mb-0 para-desc mx-auto">
                  Welcome to ListenNFT, a blockchain based marketplace that aims
                  to revolutionize the way we buy, sell, and manage digital
                  assets.
                </p>
          ...
          <div className="row justify-content-center">
            <div className="col">
              <div className="section-title text-center mb-5 pb-3">
                <h4 className="title mb-4">Popular buyers/sellers</h4>
                <p className="text-muted para-desc mb-0 mx-auto">
                  Our mission and main focus at ListenNFT is to simplify what
                  can often be a tedious and time-consuming process for
                  homeowners, prospective buyers, artists, creators, collectors,
                  etc.
                </p>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col">
              <div className="section-title text-center mb-5 pb-3">
                ...
                <p className="text-muted para-desc mb-0 mx-auto">
                  We are a huge marketplace blockchain project that aims to
                  revolutionize the way we buy, sell, and manage digital assets.
                </p>
              </div>
            </div>
            {/*end col*/}
