            ...
            <div className="col-12">
              <div className="title-heading text-center">
                ...
                <p className="text-white-50 para-desc mx-auto mb-0">
                  Welcome to ListenNFT, a marketplace blockchain project that
                  aims to revolutionize the way we buy, sell, and manage digital
                  assets.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-7 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
              <div className="section-title ms-lg-5">
                ...
                <h4 className="title mb-4">
                  We buy, sell, and manage <br /> digital assets.
                </h4>
                <p className="text-muted">
                  Our goal is to create a more efficient, transparent, and
                  secure real estate market that is accessible to everyone,
                  regardless of location or background. We do this by using
                  smart contracts on the Ethereum network to digitize real
                  estate assets and automate many of the manual processes that
                  are still done today.
                </p>
                <p className="text-muted mb-4">
                  The benefits of this system are numerous, including reduced
                  costs and increased liquidity for what has traditionally been
                  a relatively illiquid asset. By simplifying the process and
                  eliminating waste, we believe that we can create a truly
                  decentralized and barrier-free real estate marketplace that is
                  accessible to all types of end users.
                </p>
                <p className="text-muted">
                  However, we know that this is a massive undertaking that
                  requires the support and participation of property owners
                  around the world. That’s why we have designed our platform to
                  be governed by property owners, ensuring that their interests
                  are always at the forefront of our decision-making.
                </p>
                <p className="text-muted mb-4">
                  We believe that the adoption of cryptographic blockchain
                  technology by property owners worldwide is the key to
                  unlocking the full potential of the real estate market and
            ...
            <div className="col">
              <div className="section-title text-center mb-4 pb-2">
                ...
                <p className="text-muted para-desc mb-0 mx-auto">
                  ...
                  artists of all ListenNFT with their fans and unique token
                  collectors!
                </p>
              </div>
            </div>
