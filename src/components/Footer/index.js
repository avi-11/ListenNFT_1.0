            ...
            <div className="row">
              <div className="col-xl-8 col-lg-7 col-md-6">
                <h5 className="text-light fw-normal title-dark">
                  Explore ListenNFT to get the best experience
                </h5>
                ...
                <div className="row">
                  <div className="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                    ...
                    <p className="para-desc mb-0 mt-4">
                      ListenNFT is a blockchain marketplace that uses Ethereum
                      technology to digitize assets worldwide
                    </p>
                  </div>
                  {/*end col*/}

                  <div className="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <h5 className="footer-head">ListenNFT</h5>
            ...
            <div className="row align-items-center">
              <div className="col-sm-6">
                <div className="text-sm-start">
                  <p className="mb-0">Copyright © {year} by ListenNFT</p>
                </div>
              </div>
              {/*end col*/}
